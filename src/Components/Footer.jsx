const Footer = () => {
  return (
    <>
      <div className="footer flex w-full h-screen bg-[#f1f1f1]">
        <div className="leftFooter flex justify-between flex-col w-1/2 h-full px-14 pt-20 pb-16">
          <h1 className="footHeading uppercase text-9xl leading-[.75] font-bold pr-32">
            Eye-opening
          </h1>
          <div className="logo">
            <svg
        ...
        <div className="rightFooter w-1/2 h-full pt-16 pb-16">
          <h1 className="footHeading uppercase text-9xl font-bold ">
            Presentations
          </h1>
          <div className="S">
            <h4 className="my-5">S:</h4>
            <div className="links">
              <h5 className="underline">Instagram</h5>
              <h5 className="underline">Behance</h5>
              <h5 className="underline">Facebook</h5>
              <h5 className="underline">Linkedin</h5>
            </div>
          </div>
          <div className="L&M flex justify-between pr-20">
            <div className="L">
              <h4 className="my-5">L:</h4>
              <div className="links"></div>
              <h5 className="underline">202-1965 W 4th Ave</h5>
              <h5 className="underline mb-5">Vancouver, Canada</h5>
              <h5 className="underline">30 Chukarina St</h5>
              <h5 className="underline">Lviv, Ukraine</h5>
            </div>
            <div className="M">
              <h4>M:</h4>
              <div className="links">
                <h5 className="underline">Home</h5>
                <h5 className="underline">Services</h5>
                <h5 className="underline">Our work</h5>
                <h5 className="underline">About us</h5>
                <h5 className="underline">Insight</h5>
                <h5 className="underline">Contact us</h5>
              </div>
            </div>
          </div>
          <div className="E">
            <h4 className="my-5">E:</h4>
            <h5 className="underline">hello@ochi.design</h5>
          </div>
          <div className="flex justify-between pr-14 mt-16 text-[#b1b1b1]">
            <h5>© ochi design 2024. Legal Terms</h5>
            <h5>MalikZain555</h5>
          </div>
        </div>
      </div>
