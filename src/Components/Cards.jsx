const Cards = () => {
  return (
    <>
      <div className="Cards bg-[#f1f1f1] flex pt-[8%] px-10 gap-3 w-full h-[70vh]">
        <div className="card1 relative  text-[#cdea68] bg-[#004d43] w-1/2 h-[50vh] rounded-xl">
          <div className="logo absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-7xl font-semibold">
            <svg
            className="h-[4.5vw]"
              viewBox="0 0 72 30"
              fill="none"
          ...
          <h5 className="absolute bottom-8 left-10 p-[5px] border-[1px] border-[#cdea68] rounded-full  text-sm">
            &copy;2019-2022{" "}
          </h5>
        </div>
        <div className="card2 w-1/2 flex gap-3">
          <div className="card relative bg-[#212121] text-white w-1/2 h-[50vh] rounded-xl">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-7xl font-semibold">
              <img
                className="h-[6vw]"
            ...
            <h5 className="absolute bottom-8 left-5 uppercase py-[5px] px-[10px] border-[1px] border-[#fff] rounded-full text-sm">
          ...
          <div className="card relative bg-[#212121] text-white w-1/2 h-[50vh] rounded-xl">
            ...
            <h5 className="absolute uppercase bottom-8 left-5 py-[5px] px-[10px] border-[1px] border-[#fff] rounded-full text-sm">
