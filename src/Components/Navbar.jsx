const Navbar = () => {
  ...
  return (
    <>
      <div
        className="NavBar fixed z-[999] w-full h-10 px-12 py-8 items-center flex justify-between"
      >
        <div className="navleft flex justify-between items-center w-full">
          ...
          <div className="navLinks flex gap-6">
            {["Services", "Our work", "About us", "Insights", "Contact us"].map(
              (items, index) => (
                <a key={index} className={`${index === 4 && "ml-72"}`}>
                  {items}
                </a>
              )
            )}
